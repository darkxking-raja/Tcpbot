...
XP: {fix_num(data['xp'])}\n\n
°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[FFB300][b][c]MADE BY THE Tosen Codex
            """
            return msg
        else:
            msg = """
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]TOSEN CODEX [FFD3EF]!!
"""
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]LYNX-TOSEN    
[FFD700]✨ Name on Tik Tok : [FFFFFF]@tosen_7x_2❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> LYNX-TOSEN  ⚡
"""
                        ...
                        if inPuTMsG.startswith('/join'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # SUCCESS MESSAGE
                                    success_message = f"[B][C][FFD3EF]✅ SUCCESS! Joining squad with code: {CodE}!\n"
                                    await safe_send_message(response.Data.chat_type, success_message, uid, chat_id, key, iv)
                                    ...
                                    try:
                                        ...
                                        if ghost_packet:
                                            ...
                                            success_message = f"[B][C][FFD3EF]✅ SUCCESS! Ghost joining squad with code: {CodE}!\n"
                                            await safe_send_message(response.Data.chat_type, success_message, uid, chat_id, key, iv)
                                        else:
                        ...
                        if inPuTMsG.startswith('/solo'):
                            ...
                            # SUCCESS MESSAGE
                            success_message = f"[B][C][FFD3EF]✅ SUCCESS! Left the squad successfully!\n"
                            await safe_send_message(response.Data.chat_type, success_message, uid, chat_id, key, iv)
                        ...
                        if inPuTMsG.strip().startswith('/em'):
                            ...
                            if not s:
                                try:
                                    ...
                                    # SUCCESS MESSAGE
                                    success_msg = f"[B][C][FFD3EF]✅ SUCCESS! Emote {idT} sent to {len(target_uids)} player(s)!\nTargets: {', '.join(map(str, target_uids))}\n"
                                    await safe_send_message(response.Data.chat_type, success_msg, uid, chat_id, key, iv)
                        ...
                        if inPuTMsG.strip().startswith('Dont Use'):
                        ...
                        if inPuTMsG.strip().lower() in ("op", "/nm", "hi", "/help"):
                            ...
                            menu3 = '''[C][B][FFD700]═══⚓︎ LYNX-TOSEN'S BOT | HELP 3/3 ⚓︎═══[FFFF00][B]\n[FFFF00]⚡Do Any Emote \n[FFD3EF]⚡/em [uid] [I'd]\n[FFFF00]⚡For Fast Emote\n[FFD3EF]⚡/fem [uid] [e-id]\n[FFFF00]⚡ Custom emote time \n[FFD3EF]⚡/cem [uid] [e-id] [Time]\n[FFFF00]⚡For Evo Emote \n[FFD3EF]⚡/evo [uid] [1-21] \n[FFFF00]⚡fast Evo Emote\n[FFD3EF]⚡/fe [uid] [1-21]\n[FFFF00]⚡ Custom Evo Time \n[FFD3EF]⚡/ec [uid] [1-23] [time]\n[FFD3EF]━━━━━━━━━━━━[FFFF00]-'''
                        ...
                        # BOT STATUS COMMAND
                            ...
                            bot_status = f"""
[C][B][FF0000]╔══════════╗
[FFFFFF]✨ folow on TIK TOK   
[FFFFFF]          ⚡ LYNX-TOSEN❤️  
[FFFFFF]                   thank for support 
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]LYNX-TOSEN    
[FFD700]✨ Name on TIK TOK : [FFFFFF]tosen_7x❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> LYNX-TOSEN  ⚡"""
